"""Deploy OracleProofStore to Flare Coston2."""
import os
import json
...
if not ORACLE_KEY:
    raise SystemExit("Set ORACLE_KEY env var")
...
def main():
    ...
    print(f"Balance: {w3.eth.get_balance(acct.address) / 1e18} C2FLR")
    ...
    with open("coston2_deployment.json", "w") as f:
        json.dump(deploy, f, indent=2)
    print("Saved to coston2_deployment.json")
    ...
    msg_hash = keccak(b"test:maceip/freehold-relay:abc12345:build:success")
