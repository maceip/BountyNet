  ...
  return (
    <div className="dashboard-page">
      <div className="dashboard-content">
        <div className="dashboard-intro">
          <span className="dashboard-intro-title">
            Meet BountyNet, where repositories self-heal
          </span>
          <br />
          BountyNet runs continuously in the cloud, learning your codebase and improving
      ...
      <div className="dashboard-footer">
        <span>
          BountyNet is powerful and can execute on any inputs and repositories
