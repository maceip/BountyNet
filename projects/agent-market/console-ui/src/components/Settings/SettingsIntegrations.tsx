    ...
    <div className="settings-content">
      <div className="settings-integration-section">
        ...
        <p className="settings-small-text">
          ...
          <a href="https://dashboard.render.com/bountynet?utm_source=bountynet" target="_blank" rel="noopener noreferrer" className="settings-action-link">
            Render dashboard
          </a>
        </p>
        ...
        <div className="settings-integration-info-box">
          ...
          <p>
            ...
            and have{' '}
            <a href="https://render.com/docs/service-previews?utm_source=bountynet#pull-request-previews-git-backed" target="_blank" rel="noopener noreferrer" className="settings-action-link">
              preview deployments
            </a>{' '}
